...
const Header = () => {
	return (
		<div className="bg-brandColor h-11 p-2">
			<div className="container mx-auto flex gap-5 justify-around">
				<div className="content1 flex ">
					<ul className="flex gap-x-8">
						...
						<li>
							<Link to="/yemek" className="text-white">
								Getir Yemek
							</Link>
						</li>
						<li>
							<Link to="/buyuk" className="text-white">
								Getir Büyük
							</Link>
						</li>
						<li>
							<Link to="/su" className="text-white">
								Getir Su
							</Link>
						</li>
						<li>
							<Link to="/carsi" className="text-white">
								Getir Çarşı
							</Link>
						</li>
					</ul>
				...
				<div>
					<ul className="flex gap-x-6 m-auto">
						<li className="font-semibold text-white flex gap-x-2 mx-auto">
							<LuGlobe className="my-1" />
							<a href="#">TR (Türkiye)</a>
						</li>
						<li className="font-semibold text-white flex gap-x-2 mx-auto">
